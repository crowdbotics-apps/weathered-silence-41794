"""
Django settings for weathered_silence_41794 project.
...
ROOT_URLCONF = 'weathered_silence_41794.urls'
...
WSGI_APPLICATION = 'weathered_silence_41794.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_silence_41794 API",
    "DESCRIPTION": "API documentation for weathered_silence_41794 App",
    "VERSION": "v1",
}
